...
<nav class="navbar nav-global nav-global-sign navbar-expand-sm">
    ...
    <div class="container container-sm container-sign">
        <form class="form-sign" action="signupAccount" method="post" id="signupAccount">
            ...
            <button class="btn btn-block btn-primary" type="button" id="createButton">동의하고 시작하기</button>
            <a href="./" class="btn btn-block btn-light">로그인</a>
